...
*/
		...
		finalOutput = "SSS Contribution: P" + sssContributionFloat.toFixed(2) + "<br>";
		finalOutput += "PhilHealth Contribution: P" + philHealthContributionFloat.toFixed(2) + "<br>";
		finalOutput += "Pag Ibig Contribution: P" + pagIbigContributionFloat.toFixed(2) + "<br>";
		finalOutput += "Monthly Taxable Income: P" + monthlyTaxableIncome.toFixed(2) + "<br>";
		finalOutput += "Yearly Taxable Income: P" + yearlyTaxableIncome.toFixed(2) + "<br>";
		finalOutput += "Tax Bracket: " + taxBracket + "<br>";
		finalOutput += "Yearly Tax To Pay: " + yearlyTaxToPayFloat + "<br>";
		finalOutput += "Monthly Tax To Pay: P" + monthlyTaxToPayFloat.toFixed(2) + "<br>";
		finalOutput += "Net Pay: P" + netPayFloat.toFixed(2);
